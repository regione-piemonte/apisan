...
public class CittadiniCitIdConversazioniPostService extends CodCitCodRESTBaseService {
	
	private String citId;
	private PayloadConversazione payloadConversazione;
	
	public CittadiniCitIdConversazioniPostService(String citId, PayloadConversazione payloadConversazione,
			SecurityContext securityContext, HttpHeaders httpHeaders, HttpServletRequest httpRequest) {
		super(securityContext, httpHeaders, httpRequest);
		this.citId = citId;
		this.payloadConversazione = payloadConversazione;
	}
	...
	protected Response execute() {
		...
		checkNotNull(payloadConversazione, "Impostare il payload");
		
		String url = codcitbaseurl + ApisanCodUrl.NUOVA_CONVERSAZIONE.getUrlClient(citId);
		String jsonBody = getStringFromBody(payloadConversazione);
		try {
