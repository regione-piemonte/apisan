...
******************************************************************************/
package it.csi.apisan.apisanffe.exception;
...
import it.csi.apisan.apisanffe.dto.apisanffe.ErroreDettaglio;
...
public class ErroreBuilder {
	...
	public static ErroreBuilder from(ApisanFfeStatus aas, Object... args) {
