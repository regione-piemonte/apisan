...
import it.csi.apisan.apisanffe.exception.RESTException;
...
public abstract class RESTBaseService {
	...
	public Response executeService() {
		...
		try {
			if(this.securityContext.isUserInRole(ConstantsFfe.RUOLO_MONITORAGGIO) && !this.getClass().getSimpleName().equals(ServizioAttivoGetService.class.getSimpleName())) {
