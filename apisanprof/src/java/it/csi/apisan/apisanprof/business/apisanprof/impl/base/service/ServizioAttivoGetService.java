...
public class ServizioAttivoGetService extends ProfRESTBaseService {
	...
	protected Response execute() {
		...
		info.setDescrizione("API per gestire profilo anagrafico e sanitario del cittadino vers 1.4.0");
