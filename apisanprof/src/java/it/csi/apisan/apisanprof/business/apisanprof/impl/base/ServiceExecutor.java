...
import it.csi.apisan.apisanprof.util.LogUtil.ToLog;
...
public class ServiceExecutor {
	...
	public static <T extends RESTBaseService> Response execute(Class<T> serviceClass, Object... args) {
		...
		try {
			...
			return new RestErroreException(new ErroreBuilder(500, "Errore server").getErrore( msg), msg).getResponse();
			//return Response.status(500).entity(new ErroreBuilder().getErrore(500, msg)).build();
