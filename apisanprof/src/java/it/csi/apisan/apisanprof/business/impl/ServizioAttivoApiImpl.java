...
import it.csi.apisan.apisanprof.business.apisanprof.ServizioAttivoApi;
...
public class ServizioAttivoApiImpl implements ServizioAttivoApi {
	...
	public Response servizioAttivoGet(String xRequestID, String xCodiceServizio, SecurityContext securityContext,
		...
		return ServiceExecutor.execute(ServizioAttivoGetService.class, xRequestID, xCodiceServizio, securityContext,
				httpHeaders);
	}
