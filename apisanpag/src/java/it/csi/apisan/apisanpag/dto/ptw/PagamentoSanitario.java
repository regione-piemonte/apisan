...
public class PagamentoSanitario   {
  ...
  private BigDecimal daPagare = null;
  private BigDecimal pagato = null;
  private BigDecimal marcaDaBollo = null;
  ...
  public BigDecimal getMarcaDaBollo() {
    return marcaDaBollo;
  }
  public void setMarcaDaBollo(BigDecimal marcaDaBollo) {
  ...
  /**
   * elenco di identificativi emesso dal sistema ricetta elettronica
   **/
  
  @ApiModelProperty(value = "elenco di identificativi emesso dal sistema ricetta elettronica")
  @JsonProperty("nre") 
