CREATE TABLE apisan_pag_t_log_chiamate (
	pag_t_log_chiamate_id bigserial NOT NULL,
	...
	CONSTRAINT apisan_pag_t_log_chiamate_pk PRIMARY KEY (pag_t_log_chiamate_id)
);