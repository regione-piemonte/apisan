...
public class CittadiniCfBeneficiariGetService extends EsenRESTBaseService {
	
	@Autowired
	EsenServiceClient client;
	String cf;
	
	public CittadiniCfBeneficiariGetService(String cf, SecurityContext securityContext, HttpHeaders httpHeaders) {
	...
	protected Response execute() {
		...
		String ret = client.getServiceWithPathCf(shibIdentitaCodiceFiscale, xRequestID, xCodiceServizio, cf, "beneficiari");
