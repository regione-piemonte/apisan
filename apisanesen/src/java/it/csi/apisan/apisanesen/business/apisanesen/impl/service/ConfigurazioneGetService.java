...
public class ConfigurazioneGetService extends EsenRESTBaseService{
	@Autowired
	EsenServiceClient client;

	public ConfigurazioneGetService(SecurityContext securityContext, HttpHeaders httpHeaders) {
	...
	protected Response execute() {
		...
		String ret = client.getServiceWithoutParam(shibIdentitaCodiceFiscale, xRequestID, xCodiceServizio, "configurazione");
