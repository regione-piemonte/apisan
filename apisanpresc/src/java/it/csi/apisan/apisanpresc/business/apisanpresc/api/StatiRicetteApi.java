...
@io.swagger.annotations.Api(description = "the stati-ricette API")

public interface StatiRicetteApi  {
   
    @GET
    
    
    @Produces({ "application/json" })
    @io.swagger.annotations.ApiOperation(value = "Lista degli stati ricette", notes = "Restituisce la lista dei possibili stati delle ricette elettroniche. Utile per mostrare dei filtri ", response = ModelStatoRicetta.class, responseContainer = "List", tags={ "Ricette", })
    @io.swagger.annotations.ApiResponses(value = { 
        @io.swagger.annotations.ApiResponse(code = 200, message = "La richiesta è andata a buon fine e restituisce l'array dei possibili stati delle ricette", response = ModelStatoRicetta.class, responseContainer = "List"),
