...
import it.csi.apisan.apisanpresc.exceptionmapper.BadRequestExceptionMapper;
import it.csi.apisan.apisanpresc.exceptionmapper.InternalServerErrorExceptionMapper;
import it.csi.apisan.apisanpresc.exceptionmapper.MethodNotAllowedExceptionMapper;
import it.csi.apisan.apisanpresc.exceptionmapper.NotFoundExceptionMapper;
import it.csi.apisan.apisanpresc.exceptionmapper.UnauthorizedExceptionMapper;
import it.csi.apisan.apisanpresc.util.LogUtil;
import it.csi.apisan.apisanpresc.util.SpringApplicationContextProvider;



@ApplicationPath("ricette/api/v1")
