...
******************************************************************************/
package it.csi.apisan.apisantrovaun.exception;
...
import it.csi.apisan.apisantrovaun.dto.apisantrovaun.ErroreDettaglio;
import it.csi.apisan.apisantrovaun.dto.apisantrovaun.Errore;
import it.csi.apisan.apisantrovaun.exception.ErroreBuilder;
import it.csi.apisan.apisantrovaun.exception.ErroreRESTException;

public class ErroreBuilder {
	private Errore errore;
	

	public static ErroreBuilder from(ApisanTrovaUnStatus aas, Object... args) {
