...
import it.csi.apisan.apisantrovaun.business.apisantrovaun.impl.base.service.ServizioAttivoGetService;
...
public abstract class RESTBaseService {
	...
	public Response executeService() {
		...
		try {
			if(this.securityContext.isUserInRole(TrovaUnConstants.RUOLO_MONITORAGGIO) && !this.getClass().getSimpleName().equals(ServizioAttivoGetService.class.getSimpleName())) {
