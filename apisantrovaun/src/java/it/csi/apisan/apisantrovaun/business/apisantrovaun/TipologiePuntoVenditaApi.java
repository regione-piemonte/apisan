...
import it.csi.apisan.apisantrovaun.dto.apisantrovaun.ModelPuntoVenditaTipologia;
...
@Path("/tipologie-punto-vendita")


@io.swagger.annotations.Api(description = "the tipologie-punto-vendita API")

public interface TipologiePuntoVenditaApi  {
   
    @GET
    
    
    @Produces({ "application/json" })
    @io.swagger.annotations.ApiOperation(value = "Lista tipologie punto vendita", notes = "Elenco delle tipologie dei punti vendita di prodotti per celiachia ", response = ModelPuntoVenditaTipologia.class, responseContainer = "List", tags={  })
    @io.swagger.annotations.ApiResponses(value = { 
        @io.swagger.annotations.ApiResponse(code = 200, message = "Operazione eseguita con successo ", response = ModelPuntoVenditaTipologia.class, responseContainer = "List"),
