...
import it.csi.apisan.apisantrovaun.dto.apisantrovaun.ModelOspedaleTipologia;
...
@Path("/tipologie-ospedale")


@io.swagger.annotations.Api(description = "the tipologie-ospedale API")

public interface TipologieOspedaleApi  {
   
    @GET
    
    
    @Produces({ "application/json" })
    @io.swagger.annotations.ApiOperation(value = "Lista tipologie ospedali", notes = "Elenco delle tipologie di ospedali ", response = ModelOspedaleTipologia.class, responseContainer = "List", tags={  })
    @io.swagger.annotations.ApiResponses(value = { 
        @io.swagger.annotations.ApiResponse(code = 200, message = "Operazione eseguita con successo ", response = ModelOspedaleTipologia.class, responseContainer = "List"),
