...
import it.csi.apisan.apisantrovaun.dto.apisantrovaun.ModelTipologiaAssistenza;
...
@Path("/tipologie-assistenza")


@io.swagger.annotations.Api(description = "the tipologie-assistenza API")

public interface TipologieAssistenzaApi  {
   
    @GET
    
    
    @Produces({ "application/json" })
    @io.swagger.annotations.ApiOperation(value = "Lista tipologie assistenza", notes = "Elenco delle tipologie di assistenza delle strutture sanitarie ", response = ModelTipologiaAssistenza.class, responseContainer = "List", tags={  })
    @io.swagger.annotations.ApiResponses(value = { 
        @io.swagger.annotations.ApiResponse(code = 200, message = "Operazione eseguita con successo ", response = ModelTipologiaAssistenza.class, responseContainer = "List"),
