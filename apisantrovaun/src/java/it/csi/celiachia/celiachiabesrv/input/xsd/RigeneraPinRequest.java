...
/**
 * <p>Classe Java per RigeneraPinRequest complex type.
 * 
 * <p>Il seguente frammento di schema specifica il contenuto previsto contenuto in questa classe.
 * 
 * <pre>
 * &lt;complexType name="RigeneraPinRequest">
 *   &lt;complexContent>
...
@XmlType(name = "RigeneraPinRequest", propOrder = {
    "citId"
})
public class RigeneraPinRequest
