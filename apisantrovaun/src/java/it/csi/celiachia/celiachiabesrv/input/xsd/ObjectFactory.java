...
public class ObjectFactory {
    ...
    private final static QName _UsaPinDaQRCodeGOCCitId_QNAME = new QName("http://input.celiachiabesrv.celiachia.csi.it/xsd", "citId");
    private final static QName _UsaPinDaQRCodeGOCQrCode_QNAME = new QName("http://input.celiachiabesrv.celiachia.csi.it/xsd", "qrCode");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://input.celiachiabesrv.celiachia.csi.it/xsd", name = "citId", scope = UsaPinDaQRCodeGOC.class)
    public JAXBElement<String> createUsaPinDaQRCodeGOCCitId(String value) {
        return new JAXBElement<String>(_UsaPinDaQRCodeGOCCitId_QNAME, String.class, UsaPinDaQRCodeGOC.class, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://input.celiachiabesrv.celiachia.csi.it/xsd", name = "qrCode", scope = UsaPinDaQRCodeGOC.class)
    public JAXBElement<String> createUsaPinDaQRCodeGOCQrCode(String value) {
        return new JAXBElement<String>(_UsaPinDaQRCodeGOCQrCode_QNAME, String.class, UsaPinDaQRCodeGOC.class, value);
    }
    ...
    public JAXBElement<String> createRicercaErogazioniAssistitoCitId(String value) {
        return new JAXBElement<String>(_UsaPinDaQRCodeGOCCitId_QNAME, String.class, RicercaErogazioniAssistito.class, value);
    }
    ...
    public JAXBElement<String> createVerificaSaldoAssistitoCitId(String value) {
        return new JAXBElement<String>(_UsaPinDaQRCodeGOCCitId_QNAME, String.class, VerificaSaldoAssistito.class, value);
    }
    ...
    public JAXBElement<String> createGetPinAssistitoCitId(String value) {
        return new JAXBElement<String>(_UsaPinDaQRCodeGOCCitId_QNAME, String.class, GetPinAssistito.class, value);
    }
    ...
    public JAXBElement<String> createRigeneraPinRequestCitId(String value) {
        return new JAXBElement<String>(_UsaPinDaQRCodeGOCCitId_QNAME, String.class, RigeneraPinRequest.class, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://input.celiachiabesrv.celiachia.csi.it/xsd", name = "citId", scope = BCKRIGPinGOC.class)
    public JAXBElement<String> createBCKRIGPinGOCCitId(String value) {
        return new JAXBElement<String>(_UsaPinDaQRCodeGOCCitId_QNAME, String.class, BCKRIGPinGOC.class, value);
    }
