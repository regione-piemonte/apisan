...
/**
 * <p>Classe Java per ElencoErogRequest complex type.
 * 
 * <p>Il seguente frammento di schema specifica il contenuto previsto contenuto in questa classe.
 * 
 * <pre>
 * &lt;complexType name="ElencoErogRequest">
 *   &lt;complexContent>
...
@XmlType(name = "ElencoErogRequest", propOrder = {
    "citId"
})
public class ElencoErogRequest
