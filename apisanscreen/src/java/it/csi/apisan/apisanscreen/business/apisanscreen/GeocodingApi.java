...
import it.csi.apisan.apisanscreen.dto.apisanscreen.ModelIndiceLoccsi;
...
@io.swagger.annotations.Api(description = "the geocoding API")
...
public interface GeocodingApi  {
    ...
    @io.swagger.annotations.ApiOperation(value = "Geocoding", notes = "Permette di ottenere le coordinate a partire da un indirizzo/comune ", response = ModelIndiceLoccsi.class, responseContainer = "List", tags={  })
    @io.swagger.annotations.ApiResponses(value = { 
        @io.swagger.annotations.ApiResponse(code = 200, message = "Operazione eseguita con successo ", response = ModelIndiceLoccsi.class, responseContainer = "List"),
