...
@ApiModel(description="Rappresenta la tipologia di un documento con una descrizione estesa. NOTA: Il campo \"descrizione_estesa\" è stato inserito in seguito e per evitare impatti sullo sviluppo già avviato è stato deciso di inserirlo come model aggiuntivo e di usarlo solo sui nuovi endpoint. In futuro valorare se è possibile uniformare il tutto adeguando i vecchi endpoint a questo nuovo model ")

public class ModelTipologiaDocumentoV2   {
  ...
  public boolean equals(Object o) {
    ...
    ModelTipologiaDocumentoV2 modelTipologiaDocumentoV2 = (ModelTipologiaDocumentoV2) o;
    return Objects.equals(codice, modelTipologiaDocumentoV2.codice) &&
        Objects.equals(descrizione, modelTipologiaDocumentoV2.descrizione);
  }
  ...
  public String toString() {
    ...
    sb.append("class ModelTipologiaDocumentoV2 {\n");
