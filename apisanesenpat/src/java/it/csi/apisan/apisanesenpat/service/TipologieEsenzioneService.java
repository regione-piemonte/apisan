...
public class TipologieEsenzioneService extends RESTBaseService {

    private LogUtil _log = new LogUtil(TipologieEsenzioneService.class);
    ...
    @Value("${serviceTipologieEsenzioni}")
    String servicePath;
    ...
    public TipologieEsenzioneService(String shibIdentitaCodiceFiscale, String xRequestId, String xForwardedFor, String xCodiceServizio, String citId, SecurityContext securityContext, HttpHeaders httpHeaders, HttpServletRequest request, HttpServletResponse response) {
        ...
        this._citId = citId;
//        this._certificatoId             = certificatoId;
    }
    ...
    protected Response execute() {
        ...
        //final String uri = basePath + contextPath + servicePath + "?CodiceFiscale=" + _shibIdentitaCodiceFiscale;
