...
@io.swagger.annotations.Api(description = "the disclaimer-trattamento-dati API")

public interface DisclaimerTrattamentoDatiApi  {
   
    @GET
    
    
    
    @io.swagger.annotations.ApiOperation(value = "Disclaimer trattamento dati", notes = "Permette di ottenere il testo del disclaimer per il trattamento dei dati in caso di malattie rare ", response = Void.class, tags={ "Statiche", })
