...
@io.swagger.annotations.Api(description = "the tipologie-invalidita API")

public interface TipologieInvaliditaApi  {
   
    @GET
    
    
    
    @io.swagger.annotations.ApiOperation(value = "Lista tipologie invalidità", notes = "Permette l'elenco delle tipologie di invalidità ", response = ModelTipologiaInvaliditaV3.class, responseContainer = "List", tags={ "Statiche", })
    @io.swagger.annotations.ApiResponses(value = { 
        @io.swagger.annotations.ApiResponse(code = 200, message = "Operazione eseguita con successo ", response = ModelTipologiaInvaliditaV3.class, responseContainer = "List"),
