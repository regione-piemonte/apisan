...
@io.swagger.annotations.Api(description = "the disclaimer-iscrizione-malattie-rare API")

public interface DisclaimerIscrizioneMalattieRareApi  {
   
    @GET
    
    
    
    @io.swagger.annotations.ApiOperation(value = "Disclaimer iscrizione", notes = "Permette di ottenere il testo del disclaimer per l'iscrizione al registro interregionale delle malattie rare ", response = Void.class, tags={ "Statiche", })
