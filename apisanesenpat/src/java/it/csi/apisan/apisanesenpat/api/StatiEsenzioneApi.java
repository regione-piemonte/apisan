...
public interface StatiEsenzioneApi  {
    ...
    @io.swagger.annotations.ApiOperation(value = "Lista stati esenzioni", notes = "Permette di ottenere la lista degli stati dell'esenzione ", response = ModelEsenzioneStato.class, responseContainer = "List", tags={ "Statiche", })
    @io.swagger.annotations.ApiResponses(value = { 
        @io.swagger.annotations.ApiResponse(code = 200, message = "Operazione eseguita con successo ", response = ModelEsenzioneStato.class, responseContainer = "List"),
