...
@Path("/motivazioni-soggiorno")


@io.swagger.annotations.Api(description = "the motivazioni-soggiorno API")

public interface MotivazioniSoggiornoApi  {
   
    @GET
    
    
    @Produces({ "application/json" })
    @io.swagger.annotations.ApiOperation(value = "Lista motivazioni del soggiorno", notes = "Restituisce la lista delle motivazioni di soggiorno. Permette al front-end di popolare la select da cui il cittadino dovrà scegliere la motivazione del soggiorno. ", response = ModelMotivazioneSoggiorno.class, responseContainer = "List", tags={  })
    @io.swagger.annotations.ApiResponses(value = { 
        @io.swagger.annotations.ApiResponse(code = 200, message = "Operazione eseguita con successo ", response = ModelMotivazioneSoggiorno.class, responseContainer = "List"),
