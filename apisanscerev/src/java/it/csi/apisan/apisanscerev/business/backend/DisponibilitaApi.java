...
@io.swagger.annotations.Api(description = "the disponibilita API")
...
public interface DisponibilitaApi  {
    ...
    @io.swagger.annotations.ApiOperation(value = "Disponibilità", notes = "Restituisce informazioni relative alle disponibilità dei medici ", response = ModelDisponibilita.class, responseContainer = "List", tags={  })
    @io.swagger.annotations.ApiResponses(value = { 
        @io.swagger.annotations.ApiResponse(code = 200, message = "Operazione eseguita con successo ", response = ModelDisponibilita.class, responseContainer = "List"),
