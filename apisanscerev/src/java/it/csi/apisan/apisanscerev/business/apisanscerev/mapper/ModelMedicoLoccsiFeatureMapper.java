...
public class ModelMedicoLoccsiFeatureMapper extends BaseMapper<ModelMedicoLoccsi, Propertie> {

	@Override
	public Propertie to(ModelMedicoLoccsi source) {
		// TODO Auto-generated method stub
		return null;
	}

	@Override
	public ModelMedicoLoccsi from(Propertie dest) {
		if(dest == null) {
			return null;
		}
