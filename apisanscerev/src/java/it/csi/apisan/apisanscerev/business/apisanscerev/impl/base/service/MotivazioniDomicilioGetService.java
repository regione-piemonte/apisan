...
public class MotivazioniDomicilioGetService extends ScerevRESTBaseService {
	
	@Autowired
	ScerevServiceClient scerevServiceClient;
	
	public MotivazioniDomicilioGetService(SecurityContext securityContext, HttpHeaders httpHeaders) {
	...
	protected Response execute() {
		...
		List<ModelMotivazioneDomicilio> lista = scerevServiceClient.getMotivazioniDomicilio(this.httpHeaders);
