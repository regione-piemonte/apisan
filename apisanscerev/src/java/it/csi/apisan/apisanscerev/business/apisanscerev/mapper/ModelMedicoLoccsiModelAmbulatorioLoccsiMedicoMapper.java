...
public class ModelMedicoLoccsiModelAmbulatorioLoccsiMedicoMapper extends BaseMapper<ModelMedicoLoccsi, ModelAmbulatorioLoccsiMedico> {

	@Override
	public ModelAmbulatorioLoccsiMedico to(ModelMedicoLoccsi source) {
		if(source == null) {
			return null;
		}
	...
	@Override
	public ModelMedicoLoccsi from(ModelAmbulatorioLoccsiMedico dest) {
		if(dest == null) {
			return null;
		}
		ModelMedicoLoccsi source = new ModelMedicoLoccsi();
