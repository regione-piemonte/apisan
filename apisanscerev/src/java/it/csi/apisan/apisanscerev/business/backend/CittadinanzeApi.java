...
@io.swagger.annotations.Api(description = "the cittadinanze API")
...
public interface CittadinanzeApi  {
    ...
    @io.swagger.annotations.ApiOperation(value = "Lista cittadinanze", notes = "Restituisce la lista delle cittadinanze. Permette al front-end di popolare la select da cui il cittadino seleziona la cittadinanza. ", response = ModelCittadinanza.class, responseContainer = "List", tags={  })
    @io.swagger.annotations.ApiResponses(value = { 
        @io.swagger.annotations.ApiResponse(code = 200, message = "Operazione eseguita con successo ", response = ModelCittadinanza.class, responseContainer = "List"),
