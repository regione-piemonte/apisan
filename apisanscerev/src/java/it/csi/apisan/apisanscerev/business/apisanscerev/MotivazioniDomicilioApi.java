...
@io.swagger.annotations.Api(description = "the motivazioni-domicilio API")
...
public interface MotivazioniDomicilioApi  {
    ...
    @io.swagger.annotations.ApiOperation(value = "Lista motivazioni del domicilio", notes = "Restituisce la lista delle motivazioni del domicilio. Permette al front-end di popolare la select da cui il cittadino seleziona la motivazione del domicilio. ", response = ModelMotivazioneDomicilio.class, responseContainer = "List", tags={  })
    @io.swagger.annotations.ApiResponses(value = { 
        @io.swagger.annotations.ApiResponse(code = 200, message = "Operazione eseguita con successo ", response = ModelMotivazioneDomicilio.class, responseContainer = "List"),
