...
public abstract class RESTBaseService {
	...
	public Response executeService() {
		...
		try {
			if(this.securityContext.isUserInRole(ScerevConstants.RUOLO_MONITORAGGIO) && !this.getClass().getSimpleName().equals(ServizioAttivoGetService.class.getSimpleName())) {
