...
public class DateNascitaTMapper extends BaseMapper<Date, String> {
	
	private LogUtil log = new LogUtil(DateNascitaTMapper.class);
	
	protected SimpleDateFormat sd;
	
	
	public DateNascitaTMapper() {
		this("yyyy-MM-dd");
	}
	
	public DateNascitaTMapper(String pattern) {
