...
@Path("/tipologie-medico")


@io.swagger.annotations.Api(description = "the tipologie-medico API")

public interface TipologieMedicoApi  {
   
    @GET
    
    
    @Produces({ "application/json" })
    @io.swagger.annotations.ApiOperation(value = "Lista delle tipologie medico", notes = "Lista delle tipologie di medico disponibile. Permette al front-end di popolare la select che il cittadino potrà usare per filtrare i risultati della ricerca della lista medici. ", response = ModelMedicoTipologia.class, responseContainer = "List", tags={  })
    @io.swagger.annotations.ApiResponses(value = { 
        @io.swagger.annotations.ApiResponse(code = 200, message = "Operazione eseguita con successo ", response = ModelMedicoTipologia.class, responseContainer = "List"),
