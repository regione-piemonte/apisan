...
import it.csi.apisan.apisanscerev.dto.scerev.ModelCambioMedicoRichiestaChatOperatore;
...
import it.csi.apisan.apisanscerev.dto.scerev.ModelDocumentoLettura;
...
public class ModelCambioMedicoRichiesta   {
  ...
  /**
   * true se la richiesta è annullabile, false altrimenti ri Permette al front-end di mostrare o meno il bottone \&quot;annulla\&quot; sulla richiesta del medico. 
   **/
  
  @ApiModelProperty(value = "true se la richiesta è annullabile, false altrimenti ri Permette al front-end di mostrare o meno il bottone \"annulla\" sulla richiesta del medico. ")
