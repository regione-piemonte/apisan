...
public class ModelMedicoLoccsiAmbulatorio   {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(id, modelMedicoLoccsiAmbulatorio.id) &&
        ...
        Objects.equals(orari, modelMedicoLoccsiAmbulatorio.orari);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, provincia, comune, cap, indirizzo, telefono, email, note, rapportoLavoroId, tipo, coordinate, orari);
  }
