...
public class ModelCambioMedicoRichiestaDatiAggiuntivi   {
  ...
  @ApiModelProperty(value = "")
  @JsonProperty("motivazione_domicilio") 
  ...
  @JsonProperty("assitenza_temporanea_data_fine_validita") 
  ...
  @JsonProperty("lavoro_professione") 
  ...
  @JsonProperty("lavoro_partita_iva") 
  ...
  @JsonProperty("lavoro_numero_iscrizione") 
  ...
  @JsonProperty("lavoro_azienda_telefono") 
  ...
  @JsonProperty("lavoro_azienda_provincia") 
  ...
  @JsonProperty("lavoro_azienda_comune") 
  ...
  @JsonProperty("lavoro_azienda_indirizzo") 
  ...
  @JsonProperty("lavoro_azienda_civico") 
  ...
  @JsonProperty("lavoro_data_fine_validita_contratto") 
  ...
  @JsonProperty("studio_nome_istituto") 
  ...
  @ApiModelProperty(example = "Torino", value = "La provincia dell'azienda")
  @JsonProperty("studio_istituto_provincia") 
  ...
  @ApiModelProperty(example = "Torino", value = "Il comune dell'azienda")
  @JsonProperty("studio_istituto_comune") 
  ...
  @ApiModelProperty(example = "Corso Unione Sovietica", value = "L'indirizzo dell'azienda")
  @JsonProperty("studio_istituto_indirizzo") 
  ...
  @ApiModelProperty(example = "13", value = "Il civico dell'azienda")
  @JsonProperty("studio_istituto_civico") 
  ...
  @JsonProperty("studio_data_termine_iscrizione") 
  ...
  @JsonProperty("ricongiungimento_nome") 
  ...
  @JsonProperty("ricongiungimento_cognome") 
  ...
  @JsonProperty("ricongiungimento_codice_fiscale") 
  ...
  @JsonProperty("ricongiungimento_parentela") 
  ...
  /**
   * indica la motivazione nel caso di deroga di ambito
   **/
  
  @ApiModelProperty(value = "indica la motivazione nel caso di deroga di ambito")
  @JsonProperty("motivazione_domanda") 
