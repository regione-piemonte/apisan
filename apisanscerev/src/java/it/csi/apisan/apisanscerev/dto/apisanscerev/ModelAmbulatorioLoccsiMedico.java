...
public class ModelAmbulatorioLoccsiMedico   {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, nome, cognome, sesso, dataNascita, codiceFiscale, mail, specializzazioni, autolimitato, massimale, massimaleDeroga, massimaleAssistenzaTemporanea, massimaleInfanzia, codiceRegionale, disponibilita, distretto, ambito, tipologia, asl);
  }
