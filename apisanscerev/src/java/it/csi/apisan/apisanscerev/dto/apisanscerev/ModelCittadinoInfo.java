...
public class ModelCittadinoInfo   {
  ...
  @JsonProperty("data_inizio_assistenza") 
  ...
  @JsonProperty("data_fine_assistenza") 
  ...
  @JsonProperty("data_inizio_assistenza_medico") 
  ...
  @JsonProperty("data_revoca_medico") 
  ...
  @JsonProperty("data_revoca_assistenza") 
