CREATE TABLE apisan_scerev_t_log_chiamate (
	scerev_t_log_chiamate_id bigserial NOT NULL,
	...
	CONSTRAINT apisan_scerev_t_log_chiamate_pk PRIMARY KEY (scerev_t_log_chiamate_id)
);