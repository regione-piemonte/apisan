...
public class ErroreConsenso   {
  ...
  private Consenso consenso = null;
  ...
  public boolean equals(Object o) {
    ...
    ErroreConsenso erroreConsenso = (ErroreConsenso) o;
    return Objects.equals(status, erroreConsenso.status) &&
        Objects.equals(code, erroreConsenso.code) &&
        Objects.equals(title, erroreConsenso.title) &&
        Objects.equals(detail, erroreConsenso.detail) &&
        Objects.equals(links, erroreConsenso.links) &&
        Objects.equals(consenso, erroreConsenso.consenso);
  }

  @Override
  public int hashCode() {
    return Objects.hash(status, code, title, detail, links, consenso);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ErroreConsenso {\n");
