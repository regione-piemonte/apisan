...
@io.swagger.annotations.Api(description = "the stati-consenso API")

public interface StatiConsensoApi  {
   
    @GET
    
    
    @Produces({ "application/json" })
    @io.swagger.annotations.ApiOperation(value = "Lista degli stati associati ai consensi", notes = "Restituisce la lista degli stati possibili del consenso; nella versione attuale è un elenco statico e quindi non si tengono in considerazione le logiche pertinenti le date di creazione/modifica ", response = TipoStato.class, responseContainer = "List", tags={  })
    @io.swagger.annotations.ApiResponses(value = { 
        @io.swagger.annotations.ApiResponse(code = 200, message = "La richiesta è andata a buon fine e restituisce l'array contenente gli stati del consenso", response = TipoStato.class, responseContainer = "List"),
