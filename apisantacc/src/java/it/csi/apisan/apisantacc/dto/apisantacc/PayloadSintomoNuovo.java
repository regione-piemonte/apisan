...
public class PayloadSintomoNuovo   {
  ...
  /**
   * La data di inizio del sintomo
   **/
  
  @ApiModelProperty(value = "La data di inizio del sintomo")
  ...
  public boolean equals(Object o) {
    ...
    PayloadSintomoNuovo payloadSintomoNuovo = (PayloadSintomoNuovo) o;
    return Objects.equals(descrizione, payloadSintomoNuovo.descrizione) &&
        Objects.equals(areaInteressata, payloadSintomoNuovo.areaInteressata) &&
        Objects.equals(dataInizio, payloadSintomoNuovo.dataInizio) &&
        Objects.equals(dataFine, payloadSintomoNuovo.dataFine);
  }

  @Override
  public int hashCode() {
    return Objects.hash(descrizione, areaInteressata, dataInizio, dataFine);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PayloadSintomoNuovo {\n");
