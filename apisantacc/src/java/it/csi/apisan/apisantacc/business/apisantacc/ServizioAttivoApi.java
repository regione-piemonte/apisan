...
public interface ServizioAttivoApi  {
    ...
    @io.swagger.annotations.ApiOperation(value = "Raggiungibilità", notes = "Serve per verificare se il servizio risponde o meno ", response = ModelInfoServizio.class, tags={ "info", })
