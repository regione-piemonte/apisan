...
//	}
//	
//	public RESTException(ApisanTaccStatus status, MediaType mediaType, Object entity, String message) {
//		this(status.getStatusCode(),mediaType,entity, message);
//	}
//
...
//	}
//	
//	public RESTException(ApisanTaccStatus status, String string) {
//		this(status.getStatusCode(),MediaType.TEXT_HTML_TYPE, string, string);
//	}
