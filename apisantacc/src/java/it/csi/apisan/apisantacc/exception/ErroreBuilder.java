...
import it.csi.apisan.apisantacc.business.integration.dao.ApisanDErrorsDao;
...
/**
 * Build dell'oggetto {@link it.csi.apisan.apisantacc.dto.apisantacc.Errore}
 * 
 */
public class ErroreBuilder {
	...
	ApisanDErrorsDao apisanDErrorsDao;
		
	public static ErroreBuilder from(ApisanTaccStatus aas, Object... args) {
	...
	private ErroreBuilder() {
		...
		apisanDErrorsDao = appContext.getBean(ApisanDErrorsDao.class);
	}
	...
	public ErroreRESTException exception() {		
		...
		return new ErroreRESTException(apisanDErrorsDao.selectErrore(this.errore));
	}
