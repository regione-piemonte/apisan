...
public interface ProvinceApi  {
    ...
    @io.swagger.annotations.ApiOperation(value = "", notes = "Fornisce l'elenco delle province. Da verificare se esiste il servizio di back end. Il filter viene permesso con eq sul codice della provincia ", response = Provincia.class, responseContainer = "List", tags={  })
    @io.swagger.annotations.ApiResponses(value = { 
        @io.swagger.annotations.ApiResponse(code = 200, message = "operazione eseguita con successo", response = Provincia.class, responseContainer = "List"),
