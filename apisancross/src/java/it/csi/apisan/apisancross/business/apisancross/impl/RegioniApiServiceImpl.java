...
import it.csi.apisan.apisancross.business.apisancross.RegioniApi;
...
public class RegioniApiServiceImpl implements RegioniApi {
	...
	@Override
	public Response regioniGet(String shibIdentitaCodiceFiscale, String xRequestID, String xCodiceServizio,
