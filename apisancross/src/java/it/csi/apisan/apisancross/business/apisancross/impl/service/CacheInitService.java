...
public class CacheInitService extends CrossRESTBaseService {
	...
	public CacheInitService(String bean, SecurityContext securityContext,
	...
	protected Response execute() {
		...
		return Response.ok().type(MediaType.TEXT_HTML).entity("Ok").build();
	}


	@SuppressWarnings("rawtypes")
	private Response initBean() {
		//final String METHOD_NAME = "initBean";
		Object beanInstance = getBeanInstance();
		cacheManager.initCache((CacheInitiator)beanInstance);
