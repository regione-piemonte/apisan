...
public interface RegioniApi  {
    ...
    @io.swagger.annotations.ApiOperation(value = "", notes = "Fornisce l'elenco delle regioni da verificare se esiste il servizio di back end. Il filter viene permesso con eq su codice  ", response = Regione.class, responseContainer = "List", tags={  })
    @io.swagger.annotations.ApiResponses(value = { 
        @io.swagger.annotations.ApiResponse(code = 200, message = "operazione eseguita con successo", response = Regione.class, responseContainer = "List"),
