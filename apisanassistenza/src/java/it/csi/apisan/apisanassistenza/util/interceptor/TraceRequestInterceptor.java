...
******************************************************************************/
package it.csi.apisan.apisanassistenza.util.interceptor;
...
import it.csi.apisan.apisanassistenza.integration.util.trace.ApisanTraceOperationDB;
import it.csi.apisan.apisanassistenza.util.ConstantApisanAssistenza;
import it.csi.apisan.apisanassistenza.util.LogUtil;
import it.csi.apisan.apisanassistenza.util.SpringApplicationContextProvider;
...
public class TraceRequestInterceptor implements PreProcessInterceptor, PostProcessInterceptor {
	...
	public ServerResponse preProcess(HttpRequest request, ResourceMethod arg1) throws Failure, WebApplicationException {
		log.debug("preProcess",  "BEGIN", null, null);
		...
		try {
			...
			tr.setComponente(ConstantApisanAssistenza.COMPONENT_NAME);
		...
		log.debug("preProcess",  "END", null, null);
		return null;
	}

	@Override
	public void postProcess(ServerResponse response) {
		log.debug("postProcess",  "BEGIN", null, null);
		...
		log.debug("postProcess",  "END", null, null);
