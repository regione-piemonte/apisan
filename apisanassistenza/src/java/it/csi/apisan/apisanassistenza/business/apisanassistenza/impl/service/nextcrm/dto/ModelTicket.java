...
public class ModelTicket {
	...
	private String createArticleType = null;
	private String createArticleSender = null;
	...
	@JsonProperty("create_article_type")
	public String getCreateArticleType() {
		return createArticleType;
	}

	public void setCreateArticleType(String createArticleType) {
	...
	@JsonProperty("create_article_sender")
	public String getCreateArticleSender() {
		return createArticleSender;
	}

	public void setCreateArticleSender(String createArticleSender) {
		this.createArticleSender = createArticleSender;
	}
	...
	public String toString() {
		...
		sb.append("    utenteRiconosciuto: ").append(toIndentedString(utenteRiconosciuto)).append("\n");
