 ...
 *       &lt;sequence>
 *         &lt;element name="input" type="{http://input.celiachiabesrv.celiachia.csi.it/xsd}RigeneraPinRequest" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class RigeneraPinAssistito {
    ...
    protected JAXBElement<RigeneraPinRequest> input;
     ...
     *     
     */
    public JAXBElement<RigeneraPinRequest> getInput() {
        return input;
    }
     ...
     *     
     */
    public void setInput(JAXBElement<RigeneraPinRequest> value) {
        this.input = value;
    }
