...
******************************************************************************/
package it.csi.apisan.apisanceliachia.util.interceptor;
...
import it.csi.apisan.apisanceliachia.business.integration.util.trace.ApisanTraceOperationDB;
import it.csi.apisan.apisanceliachia.util.ConstantsCeliachia;
import it.csi.apisan.apisanceliachia.util.LogUtil;
import it.csi.apisan.apisanceliachia.util.SpringApplicationContextProvider;
...
public class TraceRequestInterceptor implements PreProcessInterceptor, PostProcessInterceptor {
	...
	public ServerResponse preProcess(HttpRequest request, ResourceMethod arg1) throws Failure, WebApplicationException {
		...
		try {
			...
			tr.setComponente(ConstantsCeliachia.COMPONENT_NAME);
