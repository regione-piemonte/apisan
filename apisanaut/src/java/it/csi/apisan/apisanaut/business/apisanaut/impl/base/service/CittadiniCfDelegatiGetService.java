...
public class CittadiniCfDelegatiGetService extends AutRESTBaseService {
	...
	public CittadiniCfDelegatiGetService(String shibIdentitaCodiceFiscale, String xRequestID, String xCodiceServizio,
	...
	private void populateFilters(GetDelegati req, DelegaFilter f) {
...
//	private void populateFilters(GetDelegati req, Filter f) {
//
...
//
//		f.getString("cfDelegato", Operator.EQ).ifPresent(cfdelegato -> {
