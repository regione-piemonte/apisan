...
******************************************************************************/
package it.csi.apisan.apisanaut.exception;
...
//	}
//	
//	public RESTException(ApisanAutStatus status, MediaType mediaType, Object entity, String message) {
//		this(status.getStatusCode(),mediaType,entity, message);
//	}
//
...
//	}
//	
//	public RESTException(ApisanAutStatus status, String string) {
//		this(status.getStatusCode(),MediaType.TEXT_HTML_TYPE, string, string);
//	}
