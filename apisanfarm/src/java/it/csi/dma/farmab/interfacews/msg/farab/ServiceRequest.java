 ...
 *       &lt;sequence>
 *         &lt;element name="richiedente" type="{http://farab.msg.interfacews.farmab.dma.csi.it/}richiedente" minOccurs="0" form="qualified"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlSeeAlso({
    AutorizzaFarmaciaOccasionale.class,
    CertificaDevice.class,
    GetFarmaciaOccasionale.class,
    CertificaDeviceConOtp.class
})
