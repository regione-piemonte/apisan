...
******************************************************************************/
package it.csi.apisan.apisanfarm.util.interceptor;
...
import it.csi.apisan.apisanfarm.util.SpringApplicationContextProvider;
import it.csi.apisan.apisanfarm.util.trace.ApisanTraceOperationDB;
...
public class TraceRequestInterceptor implements PreProcessInterceptor, PostProcessInterceptor {
	...
	public ServerResponse preProcess(HttpRequest request, ResourceMethod arg1) throws Failure, WebApplicationException {
		...
		try {
			...
			tr.setComponente(ConstantsFarm.COMPONENT_NAME);
