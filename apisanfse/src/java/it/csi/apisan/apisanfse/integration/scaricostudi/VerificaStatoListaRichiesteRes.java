...
/**
 * <p>Classe Java per VerificaStatoListaRichiesteRes complex type.
 * 
 * <p>Il seguente frammento di schema specifica il contenuto previsto contenuto in questa classe.
 * 
 * <pre>
 * &lt;complexType name="VerificaStatoListaRichiesteRes">
 *   &lt;complexContent>
 ...
 *         &lt;element ref="{http://dma.csi.it/}statoRichiesteScarico" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "VerificaStatoListaRichiesteRes", propOrder = {
    "errori",
    "esito",
    "statoRichiesteScarico"
})
public class VerificaStatoListaRichiesteRes
    extends EnsResponse
{
    ...
    @XmlElement(namespace = "http://dma.csi.it/", nillable = true)
    protected List<StatoRichiestaScarico> statoRichiesteScarico;
    ...
    /**
     * Gets the value of the statoRichiesteScarico property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the statoRichiesteScarico property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getStatoRichiesteScarico().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<StatoRichiestaScarico> getStatoRichiesteScarico() {
        if (statoRichiesteScarico == null) {
            statoRichiesteScarico = new ArrayList<StatoRichiestaScarico>();
        }
        return this.statoRichiesteScarico;
    }
