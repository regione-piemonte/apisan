...
public class CittadiniCitIdEtichetteIdEtichettaDeleteService  extends FseEtichetteRESTBaseService{
	...
	public CittadiniCitIdEtichetteIdEtichettaDeleteService(String shibIdentitaCodiceFiscale, String xRequestID,
			String citId,
			Long idEtichetta,
	...
	protected void setSoapRequest() {
        ...
        request.setTipoOperazione(TipoOperazione.CANCELLAZIONE);    
...
//        
//        //In caso di fallimento torno errore
//	    if(risultatoCodice.equals(RisultatoCodice.FALLIMENTO)) {	    	
