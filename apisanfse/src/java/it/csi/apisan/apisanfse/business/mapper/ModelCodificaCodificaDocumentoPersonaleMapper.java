...
import it.csi.apisan.apisanfse.integration.documentoPersonale.dmacc.Codifica;

public class ModelCodificaCodificaDocumentoPersonaleMapper<D extends Codifica> extends BaseMapper<ModelCodifica , D> {
		
	private D d;
	
	public ModelCodificaCodificaDocumentoPersonaleMapper(D d) {		
		this.d=d;
	}	
