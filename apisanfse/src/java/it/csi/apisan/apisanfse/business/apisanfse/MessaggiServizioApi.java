...
@Path("/messaggi-servizio")

@Produces({ "application/json" })
@io.swagger.annotations.Api(description = "the messaggi-servizio API")

public interface MessaggiServizioApi  {
   
    @GET
    
    
    @Produces({ "application/json" })
    @io.swagger.annotations.ApiOperation(value = "get messaggi di servizio", notes = "Restituisce i mesaggi di servizio ", response = String.class, responseContainer = "List", tags={ "Utility", })
    @io.swagger.annotations.ApiResponses(value = { 
        @io.swagger.annotations.ApiResponse(code = 200, message = "Operazione eseguita con successo ", response = String.class, responseContainer = "List"),
