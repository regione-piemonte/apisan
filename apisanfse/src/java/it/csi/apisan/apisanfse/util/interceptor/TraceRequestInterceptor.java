...
******************************************************************************/
package it.csi.apisan.apisanfse.util.interceptor;
...
import it.csi.apisan.apisanfse.business.integration.util.trace.ApisanTraceOperationDB;
import it.csi.apisan.apisanfse.util.ConstantsFse;
import it.csi.apisan.apisanfse.util.LogUtil;
import it.csi.apisan.apisanfse.util.SpringApplicationContextProvider;
...
public class TraceRequestInterceptor implements PreProcessInterceptor, PostProcessInterceptor {
	...
	public ServerResponse preProcess(HttpRequest request, ResourceMethod arg1) throws Failure, WebApplicationException {
		...
		try {
			...
			tr.setComponente(ConstantsFse.COMPONENT_NAME);
